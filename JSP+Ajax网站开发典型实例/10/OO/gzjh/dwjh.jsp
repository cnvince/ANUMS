...
function validate(){
   ...
   var url="dwjh1.jsp?page="+pagenum+"&bm="+bm+"&jih="+jih;
...
<input type=hidden name=bum id=bum value=<%=new String(bum.getBytes("iso-8859-1"))%>
%>
<p style="background:6C8ACC"><img src=guide.gif>工作计划&gt;&gt;<%=new String(bm.getBytes("iso-8859-1"))%>&gt;&gt;<%=new String(jih.getBytes("iso-8859-1"))%>
</p>
<a href="dwjh.jsp?bm='单位'&st='季度计划'" style="color:black;text-decoration:none"><img src="func_list.gif">季度计划</a>&nbsp;&nbsp;
<a href="dwjh.jsp?bm='单位'&st='年计划'" style="color:black;text-decoration:none"><img src="func_list.gif">年计划</a>&nbsp;&nbsp;
