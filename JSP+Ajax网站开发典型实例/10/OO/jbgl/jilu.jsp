...
function show(){
   ...
   var ta="<table width='100%' border='0' cellpadding='0' cellspacing='1' ><tr bgcolor='6C8ACC'> <td width='30%'>加班标题</td><td width='10%'>加班人</td><td width='10%'>加班时间</td><td width='10%' >处理意见</td></tr>";
