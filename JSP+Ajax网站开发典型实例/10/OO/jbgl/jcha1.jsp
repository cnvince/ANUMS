...
<%
    ...
    String sql="select * from oa_jiaban where title='"+title+"' and starttime='"+starttime+"' and endtime='"+endtime+"' and cjr='"+name+"' and ischu='1'";
    ...
    while(rs.next()){
     ...
     String sercet=rs.getString("sercet");
