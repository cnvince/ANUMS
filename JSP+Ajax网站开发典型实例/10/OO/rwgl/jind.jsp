...
function show(){
   ...
   for(var i=0;i<content.length;i++){
	...
	ta+="<td width='11%' bgcolor='C2D6EC'>下发人</td><td width='39%' bgcolor='E4EAF4'>"+y.childNodes[4].firstChild.data+"</td>";
        ...
        ta+="<tr><td width='11%' valign='middle' height='50' bgcolor='C2D6EC' bgcolor='E4EAF4'>任务内容</td><td colspan='3' height='50' bgcolor='E4EAF4'>"+y.childNodes[9].firstChild.data+"</td> </tr>";
    ...
    <table height="22" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td height="23" align="center" valign="middle" > 
			<a href="jindt.jsp?id=<%=id%>" style="color:black;text-decoration:none"><img src="func_new.gif" border="0" align="absmiddle">新建进度报告</a>
        </tr>
	</table>
	</td>
<td class="whitebg">
