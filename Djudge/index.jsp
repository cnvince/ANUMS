...
<body>
	...
	<form class='judgeform' action="/RecordData" method="post">
	...
	<table>
		<tr>
			...
			<th scope="col"><input type="button" class="button" value="Next Query"></th>
		</tr>
		<tr>
			<td>Complete</td>
		...
		onClick="popupaddpackage('<%=Link %>')">
			...
			<td><select name="relevance" class="scoreslect">
					...
					<option   value=0 selected="selected"> Non-Relevant</option>
        ...
        <tr>
        <td>
        <input type="button" class="button" value="Next Query">
        </td>
        </tr>
	</table>
	</form>
