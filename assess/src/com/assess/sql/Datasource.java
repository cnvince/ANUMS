...
//			create tables if not exist
			...
			String sql_QueryDocuemnt="CREATE TABLE IF NOT EXISTS QUERY_DOCUMENT(Q_TERM char(100) NOT NULL, TITLE char(100) NOT NULL,LINK char(255) NOT NULL, SOURCE char(20),PRIMARY KEY (Q_TERM,LINK));";
			String sql_Result="CREATE TABLE IF NOT EXISTS RESULT(Q_TERM char(100),LINK char(255), USERID char(20), RDATE DATE, SCORE INT, ASSESSED TINYINT,PRIMARY KEY (Q_TERM, LINK, USERID));";
